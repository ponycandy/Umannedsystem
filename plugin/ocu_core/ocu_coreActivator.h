...
class ocu_coreActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit ocu_coreActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static ocu_coreActivator *m_instance;
    static PluginContext *m_CONTEXT;
    coremainwindow *m_mainWindow;
};
