#ifndef VEHICLE_2_CONTROL_H
#define VEHICLE_2_CONTROL_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle_2_controlActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle_2_controlActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle_2_controlActivator *m_instance;
