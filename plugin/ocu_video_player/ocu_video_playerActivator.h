#ifndef OCU_VIDEO_PLAYER_H
#define OCU_VIDEO_PLAYER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class ocu_video_playerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit ocu_video_playerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static ocu_video_playerActivator *m_instance;
