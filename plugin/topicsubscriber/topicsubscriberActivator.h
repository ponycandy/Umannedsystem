#ifndef TOPICSUBSCRIBER_H
#define TOPICSUBSCRIBER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class topicsubscriberActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit topicsubscriberActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static topicsubscriberActivator *m_instance;
