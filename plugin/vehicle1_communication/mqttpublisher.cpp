    ...
    ,topicname(NULL)
{
    ...
    vehicle1_communicationActivator::subscribevent(UCSEVENT::MQTTNETSET,this);
    vehicle1_communicationActivator::subscribevent(UCSEVENT::MQTTSTART,this);
    vehicle1_communicationActivator::subscribevent(UCSEVENT::MQTTSTOP,this);
}
...
void mqttpublisher::EventTriggeres(XTLevent event)
{
    ...
    {
        if(event.m_dict.value("vehicle_num")=="vehicle1")
        {
