#ifndef OCU_CAR_MANAGER_H
#define OCU_CAR_MANAGER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class ocu_car_managerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit ocu_car_managerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static ocu_car_managerActivator *m_instance;
