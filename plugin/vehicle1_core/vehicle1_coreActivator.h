#ifndef VEHICLE1_CORE_H
#define VEHICLE1_CORE_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle1_coreActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle1_coreActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle1_coreActivator *m_instance;
