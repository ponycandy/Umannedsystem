#ifndef VEHICLE_2_DATAMANAGER_H
#define VEHICLE_2_DATAMANAGER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle_2_datamanagerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle_2_datamanagerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle_2_datamanagerActivator *m_instance;
