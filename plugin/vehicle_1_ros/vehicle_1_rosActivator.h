#ifndef VEHICLE_1_ROS_H
#define VEHICLE_1_ROS_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle_1_rosActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle_1_rosActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle_1_rosActivator *m_instance;
