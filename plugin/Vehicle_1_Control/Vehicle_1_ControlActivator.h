#ifndef VEHICLE_1_CONTROL_H
#define VEHICLE_1_CONTROL_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class Vehicle_1_ControlActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit Vehicle_1_ControlActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static Vehicle_1_ControlActivator *m_instance;
    static PluginContext *m_CONTEXT;
    control_main_widget *m_main_widget;
};
