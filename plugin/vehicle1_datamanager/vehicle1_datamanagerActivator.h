#ifndef VEHICLE1_DATAMANAGER_H
#define VEHICLE1_DATAMANAGER_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle1_datamanagerActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle1_datamanagerActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle1_datamanagerActivator *m_instance;
