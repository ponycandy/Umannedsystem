#ifndef VEHICLE_1_VIDEO_H
#define VEHICLE_1_VIDEO_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class vehicle_1_videoActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit vehicle_1_videoActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static vehicle_1_videoActivator *m_instance;
    static PluginContext *m_CONTEXT;
    video_manager *m_video;
};
