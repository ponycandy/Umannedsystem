...
const char ROS_RVIZ_VIEW[]="ROS_RVIZ_VIEW";
...
const char VEHICLE_1_VIDEO[]="VEHICLE_1_VIDEO";
const char VEHICLE_1_VIDEO_CONTROL_PANEL[]="VEHICLE_1_VIDEO_CONTROL_PANEL";
const char VEHICLE_1_MAIN[]="VEHICLE_1_MAIN";
const char VEHICLE_1_CONTROL_STATE_SWITCHED[]="VEHICLE_1_CONTROL_STATE_SWITCHED";

const char VEHICLE_2_ACTIVATED[]="VEHICLE_2_ACTIVATED";
const char VEHICLE_2_CONTROL[]="VEHICLE_2_CONTROL";
const char VEHICLE_2_VIDEO[]="VEHICLE_2_VIDEO";
const char VEHICLE_2_VIDEO_CONTROL_PANEL[]="VEHICLE_2_VIDEO_CONTROL_PANEL";
const char VEHICLE_2_MAIN[]="VEHICLE_2_MAIN";
const char VEHICLE_2_CONTROL_STATE_SWITCHED[]="VEHICLE_2_CONTROL_STATE_SWITCHED";
