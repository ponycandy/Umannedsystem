...
Q_DECLARE_METATYPE(VEHICLE_2_DATA::SINGEPOINTDATA);
Q_DECLARE_METATYPE(VEHICLE_2_DATA::LOCATIONINFO);
Q_DECLARE_METATYPE(VEHICLE_2_DATA::IMUDATA);
Q_DECLARE_METATYPE(VEHICLE_2_DATA::PLUSED_SWITCH_DATA);
Q_DECLARE_METATYPE(VEHICLE_2_DATA::MOTIONCOMMAND);
Q_DECLARE_METATYPE(VEHICLE_2_DATA::IMAGE_DATA::_IMAGEDATA);
